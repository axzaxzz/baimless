--[[
    Baimless UI Library
    Gradient fixed: Top-left #100d10 to main background, visible and correct parenting!
    Usage:
...
-- FIXED: NOW inserts UIGradient *direct child* of mainFrame (correct parenting)
function Components:CreateGradient(parent, colorStart, colorEnd, rotation)
    ...
    gradient.Parent = parent -- CRITICAL: Must parent to the Frame directly!
    return gradient
end
-- (rest of code unmodified, but now gradient is attached right!)
...
function Baimless:CreateWindow()
    ...
    Components:CreateGradient(mainFrame, Theme.Colors.GradientAccent, Theme.Colors.Background, 135) -- <<--- This will now work!
